            ...
            habitSaveChip.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (user != null) {
                        ...
                        habitsData.setHabitsId(new Random().nextInt(1000000));
                        ...
                        habitsData.setHabitsTextId(habitTitle.getText().toString().toLowerCase().replaceAll("\\s","")+"_"+habitsData.getHabitsId());
                        ...
                        try{
                            databaseReference.child(habitsData.getHabitsTextId()).setValue(habitsData);
                        }
                        catch(Exception e){
                            e.getCause().getCause();
                        }
